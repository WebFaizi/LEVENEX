...
exports.LoginUserData = exports.superadminRoute = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const superadminRoute = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let token;
...
const LoginUserData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!user_Details || user_Details.role != 0) {
