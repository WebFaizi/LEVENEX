...
exports.marketingBannerDetails = exports.updateMarketingBanner = void 0;
...
const updateMarketingBanner = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const categories = yield (0, marketingBanner_model_1.storeMarketingBannerModel)(req.body, (error, result) => {
            if (error) {
                (0, apiResponse_1.ErrorResponse)(res, error.message);
            }
            (0, userActionActivity_service_1.storeUserActionActivity)(req.user.userId, "marketingBanner", "Update", `Update marketing Banner Details successfully`);
            return (0, apiResponse_1.successResponse)(res, "Update marketing Banner successfully", result);
        });
    }
    catch (error) {
        console.log(error);
...
exports.updateMarketingBanner = updateMarketingBanner;
const marketingBannerDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        (0, marketingBanner_model_1.getMarketingBannerDetail)(req.user, (error, result) => {
            if (error) {
                console.error("Error:", error);
                return (0, apiResponse_1.ErrorResponse)(res, error.message);
            }
            return (0, apiResponse_1.successResponse)(res, "Marketing Banner details", result);
        });
    }
    catch (error) {
        console.error("Error:", error);
...
exports.marketingBannerDetails = marketingBannerDetails;
//# sourceMappingURL=marketingBanner.controller.js.map