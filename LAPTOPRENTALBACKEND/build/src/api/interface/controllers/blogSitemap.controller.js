...
exports.generateBlogDetailsSitemaps = void 0;
...
const fetchListings = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield blog_schema_1.default.find();
    }
    catch (error) {
...
const generateListingUrls = () => __awaiter(void 0, void 0, void 0, function* () {
    const blogs = yield fetchListings();
    return blogs.map((blog) => {
        const blogSlug = (0, slugify_1.slugify)(blog.id);
...
const writeSitemapIndex = (filePaths) => {
    ...
    const indexContent = `<?xml version="1.0" encoding="UTF-8"?>\n<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n${filePaths
        ...
        .join("\n")}\n</sitemapindex>`;
    const indexPath = path_1.default.join(outputDir, "sitemap-blogs.xml");
...
const generateBlogDetailsSitemaps = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.generateBlogDetailsSitemaps = generateBlogDetailsSitemaps;
//# sourceMappingURL=blogSitemap.controller.js.map