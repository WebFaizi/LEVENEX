...
exports.initDemoSocketHandlers = exports.userSocketInCall = exports.userSocketMap = void 0;
exports.userSocketMap = {};
exports.userSocketInCall = {};
const initDemoSocketHandlers = (io) => {
        ...
        /*
            ...
            socket.on("initiate-call", async ({ callerId, recipientId, channelName, callType }, callback) => {
              ...
              if (typeof callback !== "function") {
                  callback = (response: any) =>  // Fallback callback function
              }
...
exports.initDemoSocketHandlers = initDemoSocketHandlers;
...
//   });
// };
//# sourceMappingURL=initDemoSocketHandlers.js.map